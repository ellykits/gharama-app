...
export default class ExpenseDetails extends Component<Props, State> {
    ...
    _postComment() {
        this.expenseService.postComment(this.props.expense.id, {
    ...
    async _addReceipt() {
        try {
            let filePath: string = await NativeModules.ImagePickerModule.pickImage();
                ...
                <View style={styles.body}>
                    <ScrollView style={styles.content}>
                        ...
                        <View style={styles.itemRow}>
                            ...
                            <Text style={styles.itemEnd}>
                                {moment(this.props.expense.date).format('YYYY-MM-DD',)}
                            </Text>
                        </View>
